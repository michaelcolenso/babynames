// Compatibility API for the 1920s decade hub. The implementation lives in
...
export interface AnchorReport { totalBirths1924: number; }
export function assertSanityAnchors(source: DecadeHubSource): AnchorReport {
  ...
  return { totalBirths1924: report.yearTotal1924! };
}
