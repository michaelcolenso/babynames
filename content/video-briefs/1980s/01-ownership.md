# Video brief 01 — Decade Ownership (1980s)

## Hook

"The most 1980s girl's name was not the most popular. It wasn't even close."
...
by how much of its lifetime fell inside the eighties. The full ranking is on
NobodyNamed."
...
- Screen recording: `/names/1980s/` ownership section, Girls tab and Most Owned
  tab (SSR table — no JS needed to capture).
- Chart still: ownership table top-10 per sex (render as-is from the page).

## Caption

"Jessica ruled the 80s by numbers. Krystle ruled it by identity. The difference
between popular and *owned*, measured on 35.6 million birth records."
...
https://nobodynamed.com/names/1980s/
