# Video brief 04 — Decade Identity (1980s)

## Hook

"This is what the 1980s sounded like."
...
- Screen recording: `/names/1980s/` DecadeHero + DecadeScorecard modules
  (SSR — capture without JS).
- Chart still: decade scorecard metric cards; ownership Most Popular top-5
  table segment.

## Caption

"Half of the 1980s shared a hundred names. The other half had 38,000 more.
The decade's sound, in numbers."
